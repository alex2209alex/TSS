...
public class CmmdcEchivalent {
    ...
    public static int calculeazaCmmdc(int a, int b) {
        ...
        if (a <= b) { // Nu are = niciun efect asupra programului pe niciun test de intrare deci e mutant de gradul 1 echivalent
            int aux = a;
            a = b;
            b = aux;
        }
